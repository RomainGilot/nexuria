...
import logoNexuria from "../../images/logo_nexuria.svg"

const navigation = [
  { name: 'Tableau de bord', href: '/', icon: HomeIcon, current: true },
  { name: 'Clients', href: '/clients', icon: UsersIcon, current: false },
  { name: 'Projets', href: '/projets', icon: FolderIcon, current: false },
  { name: 'Factures', href: '/factures', icon: DocumentDuplicateIcon, current: false },
  { name: 'Tickets', href: '/tickets', icon: ChartPieIcon, current: false },
]
          ...
          <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 pb-4 ">
            <div className="flex h-24 shrink-0 items-center">
              <img
                className=" w-auto"
                src={logoNexuria}
                alt="Logo de la micro entreprise Nexuria"
              />
            </div>
            <nav className="flex flex-1 flex-col">
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
              ...
              <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                ...
                <div className="flex items-center gap-x-4 lg:gap-x-6">
                  <button type="button" className="-m-2.5 p-2.5 text-gray-400 hover:text-gray-500">
                    <span className="sr-only">Regarder mes notifications</span>
